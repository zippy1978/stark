...
#line 202 "src/parser.hh"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_stmt = 17,                             // stmt
        S_block = 18,                            // block
        S_var_decl = 19,                         // var_decl
        S_func_decl = 20,                        // func_decl
        S_func_decl_args = 21,                   // func_decl_args
        S_ident = 22,                            // ident
        S_numeric = 23,                          // numeric
        S_expr = 24,                             // expr
        S_call_args = 25                         // call_args
      };
    };
